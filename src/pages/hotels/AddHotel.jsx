              ...
              <Row gutter={16}>
                ...
                <Col span={8}>
                  <Form.Item label="Zip Code" name="zip_code" rules={[
                    ...
                    <Input maxLength={6} placeholder="6-digit Zip" />
                  </Form.Item>
                </Col>
                <Col span={12}>
                  <Form.Item label="Latitude" name="latitude" help="e.g. 12.9716" rules={[
                ...
                <Col span={12}>
                  <Form.Item label="Longitude" name="longitude" help="e.g. 77.5946" rules={[

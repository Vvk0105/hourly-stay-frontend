...
export const PERMISSIONS = {
  ...
  HOURLY_OPERATIONS: [ROLES.SUPER_ADMIN, ROLES.HOTEL_MANAGER, ROLES.GROUP_ADMIN],

  // --- FINANCIALS ---
  VIEW_PLATFORM_FINANCIALS: [ROLES.SUPER_ADMIN, ROLES.GROUP_ADMIN],
  VIEW_HOTEL_FINANCIALS: [ROLES.HOTEL_MANAGER],
};
